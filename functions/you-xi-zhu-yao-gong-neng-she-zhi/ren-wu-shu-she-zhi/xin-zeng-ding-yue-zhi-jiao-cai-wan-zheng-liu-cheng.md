...
<summary>第三步：於上題世界創建派發任務的教師帳號</summary>

（如已有負責創建素養任務的教師帳號，請跳過此步驟）

可替現有的玩家帳號打開教師權限，抑或是直接在帳號管理介面新增教師帳號。

</details>

<details>

<summary>第四步：開票給 RD，建立素養任務的算分機制，並綁定於派發任務的教師帳號</summary>

（如已綁定算分機制，請跳過此步驟）

可參考[此票](https://redmine.bonio.com.tw/issues/25389)，建立建立素養任務的算分機制，利用算分機制，讓素養任務在答題後可以計算出分數，並將前一步驟的出題教師帳號綁定該算分機制。

***

算分機制用於讓素養任務在答題後可以計算出分數，一個帳號只能綁定一種算分機制\
目前用於：教師介面、學習中心、家長後台的雷達圖、教師介面的學生素養任務答題數據
...
<summary>第五步：於上題世界的課程題庫中創建素養任務所用的題目</summary>
...
<summary>第六步：引用出題世界的題庫至派發任務教師帳號所在的課程世界</summary>
...
<summary>第七步：將素養任務所使用的道具更改為「付費教師權限」</summary>
...
<summary>第八步：開啟派發任務教師帳號所在的課程世界的付費教師權限</summary>
...
<summary>第九步：新增欲派發成訂閱制教材的商品首任務與綁定的額外任務（請派發成一般任務）</summary>
...
（請確保已[<mark style="color:blue;">創建作業</mark>](../../teacher_console/zuo-ye-guan-li/zuo-ye.md#ru-he-jian-li-zuo-ye)<mark style="color:blue;">）</mark>
...
<summary>第十步：新增需要派送訂閱制教材的班級</summary>

（如已創建好班級，請跳過此步驟）

<mark style="background-color:purple;">設定位置：師生帳號管理介面 -> 班級管理 -> 某年級 -> 班級管理 -> 新增班級</mark>

<img src="../../../.gitbook/assets/截圖 2023-08-18 13.48.13.png" alt="" data-size="original">

點擊「增加班級」後輸入班級名稱（請將班級名稱命名為該商品名稱，方便日後辨別與派發任務）與班級學生數量，即可由帳號管理介面自動創建帳號。

</details>

<details>

<summary>第十一步：新增訂閱制教材，如需派發商品首任務與額外任務，請於對應設置欄位進行設定</summary>

<mark style="background-color:purple;">設定位置：管理者後台 -> 產品管理 -> 商品管理 -> 教材管理 -> 訂閱制教材</mark>

<img src="../../../.gitbook/assets/截圖 2023-08-15 11.49.06.png" alt="" data-size="original">

點擊「新增訂閱制商品」後，請依照以下內容填寫該訂閱制商品的各個設定項目

1. [**商品設定（訂閱制教材）**](../../admin/chan-pin-guan-li/shang-pin-guan-li/jiao-cai-guan-li/ding-yue-zhi-jiao-cai.md#shang-pin-she-ding-ding-yue-zhi-jiao-cai)
2. [**商品價格（訂閱制教材）**](../../admin/chan-pin-guan-li/shang-pin-guan-li/jiao-cai-guan-li/ding-yue-zhi-jiao-cai.md#shang-pin-jia-ge-ding-yue-zhi-jiao-cai)

</details>

<details>

<summary>第十二步：替學生批量綁定素養商品</summary>
...
<summary>第十三步：於教師後台定期派發週期性的素養任務至訂閱制任務的班級</summary>

（請將開始時間設置在商品有效期內，該孩子才會收到任務）
...
8. 選擇答案顯示設定
   ...
   * 答題後，無法查看正確答案與詳解\
     適合用於重複答題的任務類型，學生需要額外思考去想出問題的正確答案
9. 點擊「下一步」，將任務指派給訂閱制教材的班級

</details>

{% hint style="info" %}
1. 使用者需要收到教材付款以後的教材們（在教材付款及方案的有效時間之間）。如某用戶 7/1 12:00 付款月費成功，7/5 12:00 綁定使用者帳號，系統會將派發到教材綁定的班級且開始時間在 7/5 - 7/31 的任務給使用者，派發到教材綁定的班級且開始時間在 7/1-7/5 的任務會透過自動補派發機制給使用者
2. 如果用戶以信用卡扣款的方式購買訂閱制商品，當用戶的信用卡自動扣款失敗時，不會馬上斷掉訂閱，系統會有五天的緩衝期，在下次扣款日後五天內，還是有效的訂閱（可以收到任務）
{% endhint %}
