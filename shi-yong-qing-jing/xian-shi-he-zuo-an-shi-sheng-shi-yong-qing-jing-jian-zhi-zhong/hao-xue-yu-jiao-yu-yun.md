...
1. 澔學使用者（[澔學是什麼？](../../jie-shao/ming-ci-jie-shi/pagamo-zhu-ye/hao-xue.md#hao-xue-shi-shen-me)）通常都是透過親師生平台登入 PaGamO，在使用者第一次登入時會先確認使用者是否有授權 PaGamO 存取澔學資料，有才會轉跳 PaGamO 平台，我們同時能處理的登入人數為 100 人，超過就會進入等排隊登入中。
